...
/**
 * @author Song
 * @description The left hand box shows the first step of the figure, The right hand box shows the first step of the following figure.
 */
...
public enum BoxColor {
    ...
    BoxColor(String notes, Integer index) {
        this.notes = notes;
        this.index = index;
    }
